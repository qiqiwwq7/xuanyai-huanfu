  ...
  export default {
    ...
    methods: {
      ...
      requestData(callback) {
        Util.ajax.get('/note/find_recents/' + this.category.id + '/' + this.bodyData.page.pageNextId + '/' + this.bodyData.page.pageSize + '/', {params: {top: this.bodyData.page.pageNextId == '0' ? '1' : ''}}).then((response) => {
