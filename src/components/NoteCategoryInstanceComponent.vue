  ...
  export default {
    ...
    methods: {
      ...
      requestData(callback) {
        if (this.category.id) {
          Util.ajax.get('/note/find_notes_by_category_id/' + this.category.id + '/' + this.bodyData.page.pageNo + '/' + this.bodyData.page.pageSize + '/', {params: {top: this.bodyData.page.pageNo == '1' ? '1' : ''}}).then((response) => {
