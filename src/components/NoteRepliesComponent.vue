  ...
  export default {
    ...
    created () {
      if (this.currentCategoriesHash) {
        let categoryPath = this.currentCategoriesHash['/note/replies/:id']
    ...
    methods: {
      ...
      requestData(callback) {
        Util.ajax.get('/note/find_replies/' + this.category.id + '/' + this.bodyData.page.pageNo + '/' + this.bodyData.page.pageSize + '/', {params: {top: this.bodyData.page.pageNo == '1' ? '1' : ''}}).then((response) => {
